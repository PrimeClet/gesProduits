                                    ...
                                    <form class="row g-3" method="post" action="{{ route('modify.produit', ['produit' => $data['produit']->id, 'slug' => $data['produit']->slug]) }}">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-floating">
                                                <input type="text" class="form-control @error('produit') is-invalid @enderror" id="floatingName" placeholder="Nom Produit" name="produit" required value="{{ old('produit') ? : $data['produit']->nom }}">
                                                <label for="floatingName">Nom Produit</label>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-floating">
                                                <input type="text" class="form-control @error('marque') is-invalid @enderror" id="floatingPassword" placeholder="Marque" name="marque" required value="{{ old('marque') ? : $data['produit']->marque }}">
                                                <label for="floatingPassword">Marque</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <textarea class="form-control @error('description') is-invalid @enderror" placeholder="Description" id="floatingTextarea" name="description" style="height: 100px;">
                                                    {{ old('description') ? :  trim($data['produit']->description) }}
                                                </textarea>
