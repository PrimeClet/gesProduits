            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-4 offset-4">
                        <h1 class="fw-bold">{{ $data['produit']->nom }}</h1>
                        <h3 class="fw-bolder">{{ $data['produit']->marque }}</h3>
                        <p class="">{{ $data['produit']->description }}</p>
                        <p class="">{{ $data['produit']->categorie->libelle }}</p>
                    </div>
